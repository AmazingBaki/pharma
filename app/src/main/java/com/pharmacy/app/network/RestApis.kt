...
import com.pharmacy.app.utils.extensions.getApiToken
import com.pharmacy.app.utils.extensions.getUserId
...
interface RestApis {
    ...
    @PUT("wc/v3/orders/{id}")
    fun updateOrder(@Path("id") id: Int,@Body request: RequestModel): Call<MyOrderData>

...
import com.pharmacy.app.databinding.FragmentHomeBinding
...
class HomeFragment : BaseViewBindingFragment<FragmentHomeBinding>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.rcvRecentSearch.setHorizontalLayout(); binding.rcvNewestProduct.setHorizontalLayout(); binding.rcvFeaturedProducts.setHorizontalLayout(); binding.rcvCategory.setHorizontalLayout()
        ...
        mCategoryAdapter = requireActivity().getCategoryAdapter(); binding.rcvCategory.adapter = mCategoryAdapter
        ...
        binding.refreshLayout.viewTreeObserver.addOnScrollChangedListener {
    ...
    private fun listAllProducts() {
        ...
        callApi(getRestApis(false).dashboard(requestModel), onApiSuccess = {
            ...
            if (it.banner_1 != null && it.banner_1.url.isNotEmpty()) {
                binding.ivBanner1.show(); binding.ivBanner1.loadImageFromUrl(it.banner_1.image); binding.ivBanner1.setOnClickListener { _ -> activity?.openCustomTab(it.banner_1.url) }
            } else {
                binding.ivBanner1.hide()
            }
            if (it.banner_2 != null && it.banner_2.url.isNotEmpty()) {
                binding.ivBanner2.show(); binding.ivBanner2.loadImageFromUrl(it.banner_2.image); binding.ivBanner2.setOnClickListener { _ -> activity?.openCustomTab(it.banner_2.url) }
            } else {
                binding.ivBanner2.hide()
            }
            if (it.banner_3 != null && it.banner_3.url.isNotEmpty()) {
                binding.ivBanner3.show(); binding.ivBanner3.loadImageFromUrl(it.banner_3.image); binding.ivBanner3.setOnClickListener { _ -> activity?.openCustomTab(it.banner_3.url) }
            } else {
    ...
    private fun setupRecentProductAdapter() {
        ...
        mRecentProductAdapter?.onItemClick = { pos, view, item ->
            ...
            activity?.launchActivity<ProductDetailActivityNew> {
                putExtra(Constants.KeyIntent.PRODUCT_ID,item.pro_id)
        ...
        if (mRecentProductAdapter != null && mRecentProductAdapter!!.itemCount <= 0) binding.rlRecentSearch.hide() else binding.rlRecentSearch.show()
    }
    ...
    private fun setClickEventListener() {
        binding.viewRecentSearch.root.setOnClickListener {
        ...
        binding.viewFeatured.root.setOnClickListener {
            activity?.launchActivity<ViewAllProductActivity> {
        ...
        binding.viewNewest.root.setOnClickListener {
            activity?.launchActivity<ViewAllProductActivity> {
        ...
        binding.viewOffer.root.setOnClickListener {
            activity?.launchActivity<ViewAllProductActivity> {
        ...
        binding.viewDeal.root.setOnClickListener {
            activity?.launchActivity<ViewAllProductActivity> {
        ...
        binding.viewYouMayLike.root.setOnClickListener {
            activity?.launchActivity<ViewAllProductActivity> {
        ...
        binding.viewSuggested.root.setOnClickListener {
            activity?.launchActivity<ViewAllProductActivity> {
